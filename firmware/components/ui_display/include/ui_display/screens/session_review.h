...
/** Cancels any pending "Delete All confirm" lv_timer before the screen is
 * torn down (nav_shell tab switch-away) - without this, an armed timer
 * would fire later against dangling lv_obj_t pointers from the already-
 * lv_obj_clean()'d content pane. Matches nav_shell_hide_fn_t. */
