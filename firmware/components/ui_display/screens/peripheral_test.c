...
void peripheral_test_show_in(lv_obj_t *parent)
{
    ...
    lv_label_set_text(note, "Heater test requires confirmation, auto-raises fan to Level 1 (80%), and auto-stops after 8s. Leaving this screen always stops any running test.");
